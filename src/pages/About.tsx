        ...
        <div className="max-w-7xl mx-auto px-5 sm:px-8 lg:px-12">
          <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-start">
            <div>
              ...
              <p className="text-[#56483E] leading-relaxed mb-5 text-base lg:text-lg">
              ...
              <p className="text-[#56483E] leading-relaxed mb-5">
            ...
            <div className="space-y-5">
              {[
                ...
                <div key={i} className="p-6 rounded-xl bg-white border border-[#00000008] shadow-sm hover:shadow-md transition-shadow">
      ...
      <section className="py-16 bg-[#F5EDE4]">
        <div className="max-w-7xl mx-auto px-5 sm:px-8 lg:px-12">
          <div className="text-center mb-12">
            ...
            <h2 className="font-heading text-2xl lg:text-3xl font-extrabold text-[#1D0E03]">What We Stand For</h2>
          </div>
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-5">
            {[
              ...
              <div key={i} className="text-center p-6 rounded-xl bg-white border border-[#00000008] shadow-sm hover:shadow-md transition-shadow">
                <div className="w-14 h-14 rounded-xl bg-[#CA5502]/10 border border-[#CA5502]/20 flex items-center justify-center text-[#CA5502] mx-auto mb-4">{v.icon}</div>
                <h3 className="font-heading text-lg font-bold text-[#1D0E03] mb-2">{v.t}</h3>
                <p className="text-sm text-[#56483E] leading-relaxed">{v.d}</p>
              </div>
            ))}
          </div>
        </div>
      ...
      <section className="py-16 lg:py-20 bg-[#014B3F]">
        <div className="max-w-4xl mx-auto px-5 sm:px-8 text-center">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
            <Link to="/quote" className="inline-flex items-center gap-2 px-8 py-4 bg-[#CA5502] text-white font-heading font-semibold rounded-lg hover:bg-[#A84502] transition-colors shadow-lg shadow-black/20 text-sm">
              Request a Quote <ArrowRight className="w-5 h-5" />
            </Link>
            <Link to="/contact" className="inline-flex items-center gap-2 px-8 py-4 bg-white/10 text-white border border-white/20 font-heading font-semibold rounded-lg hover:bg-white/20 transition-colors text-sm">
              Contact Us
            </Link>
          </div>
        </div>
