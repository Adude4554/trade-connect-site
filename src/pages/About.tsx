    ...
    <div className="min-h-screen">
      ...
      <section className="py-16 lg:py-24">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid lg:grid-cols-2 gap-12 items-start">
            <div>
              <h2 className="text-2xl lg:text-3xl font-extrabold text-white mb-6">Who We Are</h2>
              <p className="text-dim leading-relaxed mb-6 text-lg">
              ...
              {[
                ...
                <div key={i} className="p-6 rounded-xl bg-surface border border-border">
                  <div className="flex items-start gap-4">
                    <div className="w-12 h-12 rounded-xl bg-brand-light border border-brand/20 flex items-center justify-center text-brand shrink-0">{item.icon}</div>
                    <div>
      ...
      <section className="py-16 bg-surface/30">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            <h2 className="text-2xl lg:text-3xl font-extrabold text-white mb-4">Our Values</h2>
          </div>
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-6">
            {[
              ...
              <div key={i} className="text-center p-6 rounded-xl bg-zinc-950 border border-border">
                <div className="w-12 h-12 rounded-xl bg-brand-light border border-brand/20 flex items-center justify-center text-brand mx-auto mb-4">{v.icon}</div>
                <h3 className="text-lg font-bold text-white mb-2">{v.t}</h3>
                <p className="text-sm text-dim">{v.d}</p>
              </div>
            ))}
          </div>
        </div>
      ...
      <section className="py-16 lg:py-20">
        <div className="max-w-4xl mx-auto px-4 text-center">
          <h2 className="text-2xl lg:text-3xl font-extrabold text-white mb-4">Let's Work Together</h2>
          <p className="text-dim text-lg mb-8">Ready to discuss your commercial project? Contact us today.</p>
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
            <Link to="/quote" className="inline-flex items-center gap-2 px-8 py-4 bg-brand text-white font-semibold rounded-lg hover:bg-brand-hover transition-colors shadow-lg shadow-brand/25">
              Request a Quote <ArrowRight className="w-5 h-5" />
            </Link>
            <Link to="/contact" className="inline-flex items-center gap-2 px-8 py-4 bg-white/5 border border-white/10 text-white font-semibold rounded-lg hover:bg-white/10 transition-colors">
              Contact Us
            </Link>
          </div>
        </div>
