...
export function HeroSmall({ title, desc, crumbs }: { title: string; desc?: string; crumbs?: { label: string; href?: string }[] }) {
  return (
    <section className="relative py-14 lg:py-20 bg-[#F5EDE4] overflow-hidden">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-5 sm:px-8 lg:px-12">
        {crumbs && crumbs.length > 0 && (
          <nav className="flex items-center gap-2 text-sm text-[#8E8279] mb-5" aria-label="Breadcrumb">
